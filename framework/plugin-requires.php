...
function gocargo_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/revslider.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/oceanthemes-twitter-feed.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),     
        array(
            'name'               => 'OT Visual Composer', // The plugin name.
            'slug'               => 'ot_composer', // The plugin slug (typically the folder name).
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot_composer.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '1.5.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
            'is_callable'        => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
        ...
        array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot_career.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ), 
        array(            
            'name'               => 'OT Founder & Directory', // The plugin name.
            'slug'               => 'ot_founder', // The plugin slug (typically the folder name).
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot_founder.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ), 
        ...
        array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot_history.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ), 
		...
		array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot_service.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ), 
		...
		array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot_testimonial.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ), 
		...
		array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/gocargo-shipment.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
		...
		array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/meta-box-group.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
		...
		array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/meta-box-tabs.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
		...
		array(            
            ...
            'source'             => 'https://oceanthemes.site/plugins-required/gocargo/ot-themes-one-click-import.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
